...
export function createTVTable(scene, options = {}) {
  ...
  const dr0 = new THREE.Mesh(drawerGeo, tableWoodMaterial); 
  dr0.position.set(
    -tableWidth / 4,
  ...
  const dr1 = new THREE.Mesh(drawerGeo, tableWoodMaterial); 
  dr1.position.set(
    tableWidth / 4,
  ...
  const dr2 = new THREE.Mesh(drawerGeo, tableWoodMaterial); 
